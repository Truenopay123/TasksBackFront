...
import { Usuario, RespuestaAutenticacion } from '../models/user.model'; // Ajusta la ruta según tu estructura
...
class LoggerService {
  private log(level: string, message: string, data?: any) {
    ...
    console.log(logMessage); // En desarrollo, imprime en consola
    // En producción, podrías enviar logs a un servicio como Sentry o LogRocket
  }
...
export class AuthService {
  ...
  constructor(
    ...
    private logger: LoggerService // Inyectamos el servicio de logging
  ) {
